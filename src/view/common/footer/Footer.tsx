...
export function Footer() {
    return (
        <footer className="bg-gradient-to-r from-[#0d1b2a] to-[#1b263b] text-white py-16 px-5 shadow-lg">
            <div className="max-w-6xl mx-auto flex flex-wrap justify-between items-start gap-10">
                <div className="flex items-center mb-10">
                    <img src="/src/assets/IMG_E6003.png.jpg" alt="Portfolio Logo" className="h-[50px] w-auto mr-4" />
                    <h3 className="text-2xl font-bold text-white">My Portfolio</h3>
                </div>
                <div className="flex flex-col">
                    <h4 className="text-lg font-semibold mb-5">Explore</h4>
                    <ul className="list-none p-0 space-y-3">
                        <li><Link to="/home" className="text-white text-base hover:text-blue-400 transition-colors duration-300">Home</Link></li>
                        <li><Link to="/about" className="text-white text-base hover:text-blue-400 transition-colors duration-300">About</Link></li>
                        <li><Link to="/projects" className="text-white text-base hover:text-blue-400 transition-colors duration-300">Projects</Link></li>
                        <li><Link to="/contact" className="text-white text-base hover:text-blue-400 transition-colors duration-300">Contact</Link></li>
                    </ul>
                </div>
                <div className="flex flex-col">
                    ...
                    <div className="flex gap-4">
                        <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="group">
                            <svg className="w-6 h-6 text-white group-hover:text-blue-400 transition-colors duration-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        ...
                        <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="group">
                            <svg className="w-6 h-6 text-white group-hover:text-blue-400 transition-colors duration-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                        ...
                        <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="group">
                            <svg className="w-6 h-6 text-white group-hover:text-blue-400 transition-colors duration-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
            ...
            <div className="mt-10 pt-5 border-t border-white/10 text-center">
                <p className="text-sm text-white">© {new Date().getFullYear()} My Portfolio. All rights reserved.</p>
            </div>
        </footer>
    );
}